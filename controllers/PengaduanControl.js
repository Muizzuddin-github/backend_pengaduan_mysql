...
class PengaduanControl{
    static async getAll(req,res){
        try{
            ...
            const {result} = await mysqlQuery("SELECT * FROM pengaduan")
    ...
    static async getByid(req,res){
        try{
            ...
            const {result} = await mysqlQuery(`SELECT * FROM pengaduan WHERE id = ${req.params.id}`)
    ...
    static async post(req,res){
        try{
            ...
            const sql = `INSERT INTO pengaduan (foto,lokasi,deskripsi,fk_kategori_pengaduan,fk_user) VALUES('${imgUrl}','${checkPengaduan.lokasi}','${checkPengaduan.deskripsi}',${+checkPengaduan.kategoriPengaduan},${4})`
